...
export function modifyStudentProfile(id, data) {
...
export function getStudentsUsername(username) {
...
export function getStudentsNIM(nim) {
  return new Promise((resolve, reject) => {
    query(
...
export function getStudentPassword(id) {
...
export function modifyStudentPassword({id, newPassword}) {
