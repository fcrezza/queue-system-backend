import {query} from "../services/main";
...
export function modifyProfessorProfile(id, data) {
  return new Promise((resolve, reject) => {
...
export function updateProfessorStatus(status, id) {
  return new Promise((resolve, reject) => {
...
export function findProfessorByUsername(username) {
  const statement =
...
export function getProfessorsUsername(username) {
...
export function getProfessorsNIP(nip) {
  return new Promise((resolve, reject) => {
...
export function getProfessorPassword(id) {
  return new Promise((resolve, reject) => {
...
export function modifyProfessorPassword({id, newPassword}) {
...
export function getStudentsByProfessorID(id) {
  const statement =
